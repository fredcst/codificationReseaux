...
/**
* Include a single bit error within a byte depending on error rate
* If error rate = 100%, one error is added in each byte
*/
void includeError5(char *, int);
